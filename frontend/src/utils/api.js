...
export const nurseAPI = {
    ...
    getStudentMedicalChecks: async (studentId) => {
        try {
            const response = await api.get(
                `/medical-checks/student/${studentId}`
            );
            return response;
        } catch (error) {
    ...
    getMedicalChecksByCampaign: async (campaignId) => {
        try {
            const response = await api.get(
                `/medical-checks/campaign/${campaignId}`
            );
            return response;
        } catch (error) {
    ...
    scheduleMedicalCheckConsultation: async (checkId, data) => {
        try {
            ...
            console.error(
                "Error scheduling medical check consultation:",
                error
            );
            throw error;
        }
    ...
    getStudentsForMedicalCampaign: async (campaignId) => {
        try {
            ...
            console.error(
                "Error fetching students for medical campaign:",
                error
            );
            throw error;
        }
    ...
    getStudentVaccinationHistory: (studentId, vaccineId, campaignId) => {
        const params = new URLSearchParams();
        if (campaignId) {
            params.append("campaignId", campaignId);
        }
        return api.get(
            `/nurse/students/${studentId}/vaccination-history/${vaccineId}?${params.toString()}`
        );
    },
...
export const parentAPI = {
    ...
    // Vaccine operations
    getVaccines: () => api.get("/parents/vaccines"),
};
