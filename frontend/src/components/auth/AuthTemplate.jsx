                ...
                <OverlayContainer className="overlay-container">
                    <Overlay className="overlay">
                        <OverlayPanel className="overlay-panel">
                            <Title>
                                {signIn ? "Xin chào!" : "Chào mừng trở lại!"}
                            </Title>
                            <Paragraph>
                                {signIn ? (
                                    <>
                                        Nhập thông tin cá nhân của bạn và bắt
                                        đầu <br /> hành trình với chúng tôi
                                    </>
                                ) : (
                                    <>
                                        Để kết nối với chúng tôi, vui lòng đăng
                                        nhập <br /> bằng thông tin cá nhân của
                                        bạn
                                    </>
                                )}
                            </Paragraph>
