import { Modal, message, Input as AntInput, Checkbox } from "antd";
                ...
                >
                    ...
                    >
                        ...
                        <Title
                            style={{
                                ...
                                marginTop: 8,
                                background:
                                    "linear-gradient(90deg, #36AE9A 0%, #36AE9A 100%)",
                    ...
                    <Form onSubmit={handleLogin}>
                        ...
                        <AntInput
                            ...
                            prefix={
                                <MailOutlined
                                    style={{ color: "#36AE9A", fontSize: 18 }}
                                />
                            }
                            ...
                            onFocus={(e) =>
                                (e.target.style.border = "1.5px solid #36AE9A")
                            }
                            onBlur={(e) =>
                                (e.target.style.border =
                                    "1.5px solid #36AE9A33")
                            }
                            required
                        />
                        {errors.email && (
