...
const getCardColor = (consent, status) => {
  if (consent === true) return "border-l-4 border-l-emerald-400 bg-emerald-50";
  ...
  if (status === "FINISHED") return "border-l-4 border-l-slate-400 bg-slate-50";
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <Timeline
              ...
              items={sortedForms.map((form) => ({
                color: getTimelineColor(form.consent, form.status),
                children: (
                  <div className="mb-6">
                    <Card
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-3">
                          {getCardIcon(form.consent, form.status)}
                          <div>
                      ...
                      {form.consentDate && (
                        <div className="mb-2 text-xs text-gray-500 bg-gray-50 px-2 py-1 rounded">
                          ...
                          {" lúc "}
                          {new Date(form.consentDate).toLocaleDateString(
                            "vi-VN"
                          )}
                        </div>
                      )}
                      ...
                      {form.reason && (
                        <div className="mb-2 text-xs text-red-600 bg-red-50 px-2 py-1 rounded">
                          <Text strong>Lý do từ chối:</Text> {form.reason}
                        </div>
                      )}
