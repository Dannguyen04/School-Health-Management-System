            ...
            {forms.map((form) => (
              ...
              >
                ...
                <div className="mb-2">
                  ...
                  <Text style={{ wordBreak: "keep-all", whiteSpace: "nowrap" }}>
                    {form.vaccine?.name || "-"}
                  </Text>
                </div>
                <div className="mb-2">
              ...
              {consentModal.consent === true && (
                <div className="mb-4 mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <div className="mt-2 text-sm text-blue-600">
                    <Text type="secondary">
                      Bằng việc tích vào ô này, tôi cam kết rằng con em tôi sẽ
                      được tiêm chủng theo đúng lịch trình và tuân thủ các hướng
                      dẫn y tế.
                    </Text>
                  </div>
                </div>
