        ...
        try {
            ...
            formData.append(
                ...
                multiStepData.startDate
                    ? multiStepData.startDate.toISOString()
                    : ""
            );
            formData.append(
                "endDate",
            ...
            message.error(
                error.response?.data?.error ||
                    "Gửi thuốc thất bại! Vui lòng thử lại."
            );
        } finally {
            setLoading(false);
        }
                                ...
                                >
                                    {children.map((child) => (
                                        ...
                                        >
                                            ...
                                            <span
                                                className={`ml-3 px-3 py-1 rounded-full text-sm font-bold border transition-all duration-200 ${
                                                    child.class
                                                        ? "bg-[#d5f2ec] text-[#36ae9a] border-[#36ae9a]"
                    ...
                    {!showForm && (
                        <div style={{ padding: 24 }}>
                            ...
                            {pendingMedicines.length === 0 ? (
                                <Empty
                                    description="Chưa có thuốc nào, hãy thêm thuốc mới"
                                    image={
                                        <MedicineBoxOutlined
                                            style={{
                                                fontSize: 48,
                        ...
                        <div>
                            ...
                            {currentStep === 0 && (
                                ...
                                >
                                    ...
                                    >
                                        Giúp con bạn uống thuốc đúng cách và an
                                        toàn tại trường
                                    </div>
                                    <div
                                        style={{
                                    ...
                                    <Form layout="vertical">
                                        ...
                                        <Form.Item label="Loại thuốc *">
                                            ...
                                            >
                                                ...
                                                <Select.Option value="tieu-hoa">
                                                    Tiêu hóa
                                                </Select.Option>
                                                <Select.Option value="khac">
                                                    Khác
                                                </Select.Option>
                                            </Select>
                                        </Form.Item>
                            ...
                            {currentStep === 3 && (
                                <div style={{ padding: 24 }}>
                                    ...
                                    <Form layout="vertical">
                                        ...
                                        {multiStepData.importantNotes &&
                                            multiStepData.importantNotes.includes(
                                                "other"
                                            ) && (
                                                <Form.Item
                                ...
                                <div style={{ padding: 24 }}>
                                    ...
                                    <Form layout="vertical">
                                        ...
                                        <Form.Item>
                                            ...
                                            >
                                                Tôi xác nhận tất cả thông tin là
                                                chính xác
                                            </Checkbox>
                                        </Form.Item>
                                        <Form.Item>
