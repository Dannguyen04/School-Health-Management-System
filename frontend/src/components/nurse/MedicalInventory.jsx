  ...
  return (
    <div className="space-y-6">
          ...
          <Col xs={24} sm={10}>
            <Space size="small" wrap>
              ...
              <Button
                type="primary"
                icon={<ExclamationCircleOutlined />}
                onClick={() => setExpiringSoonModalVisible(true)}
              >
                  ...
                  <Statistic
                    ...
                    value={
                      lowStockItems.filter((item) => {
                        if (!item.expiryDate) return false;
                        const daysUntilExpiry = dayjs(item.expiryDate).diff(
                          dayjs(),
                          "day"
                        );
                        return daysUntilExpiry > 0 && daysUntilExpiry <= 30;
            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  ...
                  key: "shortage",
                  render: (_, record) => {
                    const shortage = record.minStock - record.quantity;
                    return (
                      <span className="text-red-500 font-medium">
      ...
      <Modal
        ...
        footer={[
          <Button key="close" onClick={() => setExpiredModalVisible(false)}>
            Đóng
          </Button>,
        ]}
        width={900}
            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  ...
                  render: (text) => {
                    const expiryDate = dayjs(text);
                    const daysExpired = dayjs().diff(expiryDate, "day");
                    return (
                      <Tooltip title={`Đã hết hạn ${daysExpired} ngày`}>
            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  ...
                  key: "daysUntilExpiry",
                  render: (_, record) => {
                    const daysUntilExpiry = dayjs(record.expiryDate).diff(
                      dayjs(),
                      "day"
                    );
                    const color = daysUntilExpiry <= 7 ? "#ff4d4f" : "#fa8c16";
                    return (
                      <span
                        style={{
                          color,
                ...
                },
                {
                  ...
                  render: (_, record) => {
                    ...
                    if (daysUntilExpiry <= 7) {
                      ...
                      return <Tag color="orange">Cần chú ý</Tag>;
                    } else {
                ...
                },
                {
                  ...
                  render: (_, record) => (
                    <Button
                      ...
                      size="small"
                      onClick={() => {
                        setExpiringSoonModalVisible(false);
                        handleEdit(record);
                      }}
                    >
                      Cập nhật
