...
const HealthCheckups = () => {
    ...
    const checkupSchema = Yup.object().shape({
        ...
        height: Yup.number()
            ...
            .max(250)
            .nullable()
            .required("Chiều cao 50-250cm"),
        weight: Yup.number()
            .min(10)
            .max(200)
            .nullable()
            .required("Cân nặng 10-200kg"),
        pulse: Yup.number().min(40).max(200).nullable().required("Mạch 40-200"),
        systolicBP: Yup.number()
            .min(60)
            .max(250)
            .nullable()
            .required("Tâm thu 60-250"),
        diastolicBP: Yup.number()
            .min(30)
            .max(150)
            .nullable()
            .required("Tâm trương 30-150"),
                    ...
                    onSubmit={async (
                        ...
                        try {
                            ...
                            if (
                                ...
                                message.error(
                                    backendMsg || "Tạo báo cáo thất bại"
                                );
                            }
                        }
                        setSubmitting(false);
                                ...
                                <>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <Option value="REQUIRES_TREATMENT">
                                                Cần điều trị
                                            </Option>
                                        </Select>
                                        <ErrorMessage
                    ...
                    <div>
                        ...
                        <Typography.Text type="secondary">
                            ...
                            {detailReport.scheduledDate
                                ? dayjs(detailReport.scheduledDate).format(
                                      "DD/MM/YYYY"
                                  )
                                : ""}
                        </Typography.Text>
                        ...
                        >
                            ...
                            <Descriptions.Item label="Ngày theo dõi">
                                {detailReport.followUpDate
                                    ? dayjs(detailReport.followUpDate).format(
                                          "DD/MM/YYYY"
                                      )
                                    : ""}
                            </Descriptions.Item>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                >
                                    <Select
                                        value={values.requiresFollowUp}
                                        onChange={(v) =>
                                            setFieldValue("requiresFollowUp", v)
                                        }
                                    >
                                        <Option value={false}>Không</Option>
                                        <Option value={true}>Có</Option>
            ...
            >
                {consultReport && (
                    ...
                    >
                        <div>
                            <b>Chiều cao:</b>{" "}
                            {consultReport.height
                                ? consultReport.height + " cm"
                                : "-"}
                        </div>
                        <div>
                            <b>Cân nặng:</b>{" "}
                            {consultReport.weight
                                ? consultReport.weight + " kg"
                                : "-"}
                        </div>
                        <div>
                            <b>Huyết áp:</b>{" "}
                            {consultReport.systolicBP &&
                            consultReport.diastolicBP
