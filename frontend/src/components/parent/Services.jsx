      ...
      <div className="lg:px-32 px-5 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <ServicesCard
            ...
            to="/parent/health-checkup-results"
            onClick={getOnClick()}
          />
          <ServicesCard
            icon={icon3}
          ...
          />
          <ServicesCard
            icon={<FaHeartbeat size={35} className="text-[#36ae9a]" />}
            title="Sự kiện y tế"
            des="Xem các sự kiện y tế liên quan đến học sinh"
            to="/parent/medical-events"
            onClick={getOnClick()}
          />
        </div>
      </div>
