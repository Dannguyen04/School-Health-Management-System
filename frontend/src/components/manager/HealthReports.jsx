    ...
    const fetchOverview = async (params = {}) => {
        ...
        try {
            ...
            if (params.reportType)
                queryParams.append("status", params.reportType);
                    ...
                    <Row gutter={16}>
                        <Col xs={24} sm={8}>
                            <Statistic
                                ...
                                suffix={`/ ${
                                    overviewData.healthStatus?.total || 0
                                }`}
                                valueStyle={{ color: "#3f8600" }}
                            />
                        </Col>
                        <Col xs={24} sm={8}>
                            <Statistic
                                title="Cần chú ý"
                                value={
                                    overviewData.healthStatus?.needsAttention ||
                                    0
                                }
                                suffix={`/ ${
                                    overviewData.healthStatus?.total || 0
                    ...
                    <Row gutter={16}>
                        <Col xs={24} sm={6}>
                            <Statistic
                                ...
                                suffix={`(${
                                    overviewData.bmi.percentages?.underweight ||
                                    0
                                }%)`}
                                valueStyle={{ color: "#1890ff" }}
                            />
                        ...
                        <Col xs={24} sm={6}>
                            <Statistic
                                ...
                                suffix={`(${
                                    overviewData.bmi.percentages?.normal || 0
                                }%)`}
                                valueStyle={{ color: "#3f8600" }}
                            />
                        </Col>
                        <Col xs={24} sm={6}>
                            <Statistic
                                ...
                                suffix={`(${
                                    overviewData.bmi.percentages?.overweight ||
                                    0
                                }%)`}
                                valueStyle={{ color: "#faad14" }}
                            />
                        ...
                        <Col xs={24} sm={6}>
                            <Statistic
                                ...
                                suffix={`(${
                                    overviewData.bmi.percentages?.obese || 0
                                }%)`}
                                valueStyle={{ color: "#cf1322" }}
                            />
                        </Col>
