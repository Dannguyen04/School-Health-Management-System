...
const COLORS = ["url(#checkedGradient)", "url(#notCheckedGradient)"];
        ...
        <div className="flex justify-center gap-8 mt-6 text-base font-medium">
            <div className="flex items-center gap-2">
                <span
                    ...
                    style={{
                        background:
                            "linear-gradient(90deg, #34d399 0%, #43e97b 100%)",
                    }}
                ></span>
                Đã khám
            </div>
            <div className="flex items-center gap-2">
                <span
                    ...
                    style={{
                        background:
                            "linear-gradient(90deg, #fb7185 0%, #ffb199 100%)",
                    }}
                ></span>
                Chưa khám
            </div>
                        ...
                        <Listbox.Options className="absolute mt-1 max-h-60 w-full overflow-auto rounded-lg bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
                            {campaigns.map((c) => (
                                <Listbox.Option
                                    ...
                                    value={c.id}
                                    className={({ active }) =>
                                        `relative cursor-pointer select-none py-3 pl-12 pr-4 text-lg ${
                                            active
                                                ? "bg-[#f0fdf4] text-[#34d399]"
                                                : "text-gray-900"
                                        }`
                                    }
                                >
                                ...
                                >
                                    {data.map((entry, index) => (
                                        <Cell
                                            ...
                                            style={{
                                                filter: "drop-shadow(0 4px 16px rgba(52,211,153,0.10))",
                                            }}
                                        />
                                    ))}
                                </Pie>
